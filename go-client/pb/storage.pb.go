...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=laptop.Storage_Driver" json:"driver,omitempty"`
...
var file_proto_storage_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x1a, 0x12, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x44,
	...
	0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d,
	...
	0x48, 0x44, 0x44, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x0d,
...
var file_proto_storage_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: laptop.Storage.Driver
	(*Storage)(nil),     // 1: laptop.Storage
	(*Memory)(nil),      // 2: laptop.Memory
}
var file_proto_storage_proto_depIdxs = []int32{
	0, // 0: laptop.Storage.driver:type_name -> laptop.Storage.Driver
	2, // 1: laptop.Storage.memory:type_name -> laptop.Memory
